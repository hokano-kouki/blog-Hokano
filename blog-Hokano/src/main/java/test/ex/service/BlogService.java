...
public class BlogService {
	...
	//登録内容を保存する処理
	public void insert(String blogTitle,String blogText,Long account_id) {
		blogDao.save(new BlogEntity(blogTitle,blogText,account_id));
	}
	...
	//AdminIdからデータを取得することをしていく
	public BlogEntity selectByAccountId(Long blogId) {
